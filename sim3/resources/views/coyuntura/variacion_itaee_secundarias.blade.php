...
{!!Html::script('js/coyuntura/chart9.js')!!}

@extends('layouts.principal')
@section ('content') 
<div ALIGN="center">
<DIV  ALIGN="center"><font size="4">Indicador trimestral de la actividad económica (ITAEE)<br>Actividades Secundarias<br>Estado de Puebla</font><br>(Variación % anual respecto al mismo trimestre del año anterior)</div>
<div ALIGN="center" id="top_x_div" style="width: 600px; height: 500px; overflow-x: scroll;overflow-y: hidden;"></div>
</div>
<caption align='center'><button align='center'><a href='/impre/43/' target='_blank'><IMG SRC='/images/excel-xls-icon.png' WIDTH='50px' height='50px'></a></button><button align='center' onclick='mos()'><IMG SRC='/images/DEF.png' WIDTH='50px' height='50px'></button><button align='center' onclick='mostrardiv()'><IMG SRC='/images/meta.png' WIDTH='50px' height='50px'></button></caption>
</body>
</html>	
@stop
...
<td>Variable:</td>
<?php
		$vars=\sim\meta::where('id_variable', '=', '43')->take(1000)->get();
		?>
...
<?php
		$vars=\sim\def::where('id_variable', '=','43')->take(1000)->get();
		?>
			@foreach ($vars as $vari)
			<?php
