...
@section ('content') 
<div ALIGN="center">
<DIV ALIGN="center"><font size="4">Exportaciones Estado de Puebla<br>Por grandes grupos de actividad económica<br></font>(Millones de dolares)</div>
<div ALIGN="center" id="top_x_div" style="width: 600px; height: 500px;"></div>
</div>
<caption align='center'><button align='center'><a href='/impre/59/' target='_blank'><IMG SRC='/images/excel-xls-icon.png' WIDTH='50px' height='50px'></a></button><button align='center' onclick='mos()'><IMG SRC='/images/DEF.png' WIDTH='50px' height='50px'></button><button align='center' onclick='mostrardiv()'><IMG SRC='/images/meta.png' WIDTH='50px' height='50px'></button></caption>
</body>
</html>	
@stop
...
<td>Variable:</td>
<?php
		$vars=\sim\meta::where('id_variable', '=', 59)->take(1000)->get();
		?>
...
<?php
		$vars=\sim\def::where('id_variable', '=', 59)->take(1000)->get();
		?>
			@foreach ($vars as $vari)
			<?php
