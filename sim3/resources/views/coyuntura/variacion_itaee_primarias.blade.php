...
{!!Html::script('js/coyuntura/chart7.js')!!}

@extends('layouts.principal')
@section ('content') 
<div ALIGN="center">
<DIV  ALIGN="center"><font size="4">Indicador trimestral de la actividad económica (ITAEE)<br>Actividades Primarias<br>Estado de Puebla</font><br>(Variación % anual respecto al mismo trimestre del año anterior)</div>
