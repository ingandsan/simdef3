...
<td>Variable:</td>
<?php
		$vars=\sim\meta::where('id_variable', '=', 93)->take(1000)->get();
		?>
...
<?php
		$vars=\sim\def::where('id_variable', '=', 93)->take(1000)->get();
		?>
			@foreach ($vars as $vari)
			<?php
