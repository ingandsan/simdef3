...
{!!Html::script('js/coyuntura/chart4.js')!!}

@extends('layouts.principal')
@section ('content') 
<div ALIGN="center">
<DIV  ALIGN="center"><font size="4">Indicador trimestral de la actividad económica (ITAEE)<br>Estado de Puebla</font><br>(Índice de volumen físico 2008=100)</div>
