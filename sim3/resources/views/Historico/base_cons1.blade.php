<?php
		...
		$cell1["f"]=number_format($vars[0]->Ciudad, 2, '.', ',').$leye2;
		$cell2["v"]=$vars[12]->Ciudad;
		$cell2["f"]=number_format($vars[12]->Ciudad, 2, '.', ',').$leye2;
		if (isset($vars[24]->Ciudad )){
		$cell3["v"]=$vars[24]->Ciudad;
		$cell3["f"]=number_format($vars[24]->Ciudad, 2, '.', ',').$leye2;
		} else {
		$cell3["v"]="null";
		$cell3["f"]="null";
		};
		...
		$cell4["f"]=number_format($vars[36]->Ciudad, 2, '.', ',').$leye2;
		} else {
		$cell4["v"]="null";
		$cell4["f"]="null";
		};
		...
		$cell5["f"]=number_format($vars[48]->Ciudad, 2, '.', ',').$leye2;
		} else {
		$cell5["v"]="null";
		$cell5["f"]="null";
		};
		...
		$cell6["f"]=number_format($vars[60]->Ciudad, 2, '.', ',').$leye2;
		} else {
		$cell6["v"]="null";
		$cell6["f"]="null";
		}
