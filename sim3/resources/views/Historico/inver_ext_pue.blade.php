...
{!!Html::script('js/chart10.js')!!}

@extends('layouts.principal')
@section ('content') 
<div >
<DIV ALIGN="center"><font size="4">Inversión Extranjera Directa<br>Estado de Puebla</font><br> (Millones de Dolares)</div>
<div ALIGN="center" id="top_x_div"></div>
</div>
<caption align='center'><button align='center'><a href='/impre/63/' target='_blank'><IMG SRC='/images/excel-xls-icon.png' WIDTH='50px' height='50px'></a></button><button align='center' onclick='mos()'><IMG SRC='/images/DEF.png' WIDTH='50px' height='50px'></button><button align='center' onclick='mostrardiv()'><IMG SRC='/images/meta.png' WIDTH='50px' height='50px'></button></caption>
</body>
</html>	
@stop
...
<td>Variable:</td>
<?php
		$vars=\sim\meta::where('id_variable', '=', 63)->take(1000)->get();
		?>
...
<?php
		$vars=\sim\def::where('id_variable', '=', 63)->take(1000)->get();
		?>
			@foreach ($vars as $vari)
			<?php
